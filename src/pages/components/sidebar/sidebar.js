      ...
      <section className="sidebar">
        <div className="content pt-50 pb-30 ps-30">
          <div className="user text-center pb-50 pe-30 flex flex-col items-center">
            {users?.profile_photo ? (
              <img
                src={`${baseUrl}/storage/images/avatar/${users?.profile_photo}`}
                alt={`avatar dari ${users.ukmName}`}
          ...
          <div className="menus">
            ...
            {users?.StoreSettingDone === 1 &&
              users?.GeneralInfomrationDone === 1 &&
              users?.bankSettingStatus === 1 &&
              users?.documentSettingStatus === 1 && (
            ...
            <div className="flex flex-col">
              <div
                className={`item ${!expandedSetting ? "mb-30" : "active"}  `}
            ...
            <div className="item mb-30">
              ...
              <p className="item-title ml-2">
                <span onClick={logout} className="text-lg text-decoration-none">
                  Log Out
                </span>
              </p>
            </div>
